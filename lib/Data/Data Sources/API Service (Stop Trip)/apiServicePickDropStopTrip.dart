...
class PickDropStopTripAPIService {
  static const String _baseUrl = 'https://bcc.touchandsolve.com/api';
  late final String authToken;

  PickDropStopTripAPIService._();

  static Future<PickDropStopTripAPIService> create() async {
    var apiService = PickDropStopTripAPIService._();
  ...
  Future<bool> TripStopped({
    ...
    print('Trip Stopping');
    final url = '$_baseUrl/vlm/route/stop/trip/$tripId';
