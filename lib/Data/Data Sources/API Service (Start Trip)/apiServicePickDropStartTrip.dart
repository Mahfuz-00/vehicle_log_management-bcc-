...
class PickDropStartTripAPIService {
  static const String _baseUrl = 'https://bcc.touchandsolve.com/api';
  late final String authToken;

  PickDropStartTripAPIService._();

  static Future<PickDropStartTripAPIService> create() async {
    var apiService = PickDropStartTripAPIService._();
  ...
  Future<bool> TripStarted({
    ...
    print('Trip Starting');
    final url = '$_baseUrl/vlm/route/start/trip/$tripId';
