...
class _LoginwithEmailUIState extends State<LoginwithEmailUI> {
  ...
  Future<void> _sendCode(String email) async {
    ...
    final apiService = await LoginWithEmailAPIService.create();
    apiService.sendForgotPasswordOTP(email).then((response) {
      if (response == 'Login otp send successfully') {
        ...
        Navigator.push(
          context,
          MaterialPageRoute(builder: (context) => LoginOPTVerficationUI()),
        );
                    ...
                    child: Column(
                      children: [
                        ...
                        const Text(
                          ...
                          'Please enter your email for OTP based login',
                          textAlign: TextAlign.center,
                          style: TextStyle(
