...
import 'package:vehicle_log_management/Template%20Models/userinfoAdmin.dart';
import '../User Type Dashboard(Demo)/DemoAppDashboard.dart';
import 'dropdownmodel.dart';

class UserInfoNew extends StatelessWidget {
  final User staff;
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              DropdownMenuModel(
                label: 'Car',
                options: ['Ford', 'Nissan', 'Toyota'],
                onChanged: (value) {
                  // Handle destination option selection
                  print('Sclected Car: $value');
                },
              ),
              Divider(),
              DropdownMenuModel(
                label: 'Driver',
                options: ['Md. Mannan Alam', 'Md. Mehedi Hasn', 'Md. Jubair Khan'],
                onChanged: (value) {
                  // Handle destination option selection
